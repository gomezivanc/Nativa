    ...
    return (
        ...
        >
            <h2 className="md:col-span-3 font-bold">
                {translations.configuration.types_of_filings.title}
            </h2>
            <hr className="md:col-span-3" />
            <span className="flex flex-col">
                <label htmlFor="code">
                    {translations.configuration.types_of_filings.form.code}
                </label>
                <InputText
                    maxLength={5} { ...register("code") }
            ...
            <span className="flex flex-col">
                <label htmlFor="name">
                    {translations.configuration.types_of_filings.form.name}
                </label>
                <InputText
