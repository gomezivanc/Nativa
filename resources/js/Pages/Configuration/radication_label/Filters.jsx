    ...
    return (
        ...
        >
            <h2 className="md:col-span-3 font-bold">
                {translations.configuration.radication_label.title}
            </h2>
            <hr className="md:col-span-3" />
            <span className="flex flex-col">
                <label htmlFor="label">
                    {translations.configuration.radication_label.form.label}
                </label>
                <InputText
                    className={{ "p-invalid": errors?.label, "w-full": true }}
                    { ...register("label") }
                />
                {errors?.label && (
            ...
            <span className="flex flex-col">
                <label htmlFor="description">
                    {translations.configuration.radication_label.form.description}
                </label>
                <InputText
