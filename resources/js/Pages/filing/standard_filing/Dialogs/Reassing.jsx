...
export const Reassing = ({  defaultVals = {}, onFinish,dataFiling }) => {
    ...
    async function submit(data) {
        ...
        data.filing = dataFiling.id;     
        
        try {
            const res = await axios.post(route("filing.reassing-to"), data);
            if (res.data.success) {
                toast.success(`${translations.auth.mail_sent} : ${res.data.mails.join(', ')}`);      
                onFinish();        
            } else {
