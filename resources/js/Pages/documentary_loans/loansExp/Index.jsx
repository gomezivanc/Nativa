...
export default function Index() {
    ...
    const exportI = (type) => {
        axios.get(route('request-loans-exp.export'), {
            params: {
                type: type,
                onlyExp: true,
                onlyWithUbications: true,
            ...
            <div className='h-full mt-4'>
                <div className='md:mx-16'>
                    ...
                    size='small' emptyMessage={ translations.auth.not_found } lazy onPage={page} paginator totalRecords={AData?.lastPage}>
                        ...
                        <Column header={ translations.request_loans.admin_loans_expfile.table.user } field={ (i) => `${i.create_by?.persona?.nombre} ${i.create_by?.persona?.apellido}`}></Column>
