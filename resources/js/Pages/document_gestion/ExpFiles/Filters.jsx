...
export const Filters = ({ onSearch, defaultVals = {}, onSetValues }) => {
    ...
    const [states,setStates] = useState([
        {
            name: translations.documental_gestion.exp_files.form.state.active,
            value: true,
        },
        {
            name: translations.documental_gestion.exp_files.form.state.inactive,
            value: false,
        },
    ])
        ...
        >
            ...
            <span className="flex flex-col">
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <>
                            <Dropdown options={users} optionLabel='persona.nombre' optionValue='id' filter
                                value={field.value}
                                onChange={(e) => field.onChange(e.value)}
                                className={{ 'p-invalid': fieldState.error, 'w-full p-inputtext-sm': true }}
                            />
            ...
            <span className="flex flex-col">
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <>
                            <Dropdown options={states} optionLabel='name' optionValue='value'
                                value={field.value}
                                onChange={(e) => field.onChange(e.value)}
                                className={{ 'p-invalid': fieldState.error, 'w-full p-inputtext-sm': true }}
                            />
