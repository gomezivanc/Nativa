        ...
        >
            ...
            <span className="flex flex-col">
                <label htmlFor="username">
                    {translations.documental_gestion.dependency.form.code}
                </label>
                <InputText
                    type="number"
                    maxLength={5}
                    {...register("code")}
                    className={{ "p-invalid": errors?.code, "w-full": true }}
                />
                {errors?.code && (
            ...
            <span className="flex flex-col">
                <label htmlFor="username">
                    {translations.documental_gestion.dependency.form.name}
                </label>
                <InputText
                    maxLength={255}
                    {...register("name")}
            ...
            <span className="flex flex-col">
                <label htmlFor="username">
                    {
                        translations.documental_gestion.dependency.form
                            .g_d_parent_id
                    }
                </label>
                <Controller
            ...
            <span className="flex flex-col">
                <label htmlFor="username">
                    {translations.documental_gestion.dependency.form.dep_id}
                </label>
                <Controller
                    name="dep_id"
                    control={control}
            ...
            <span className="flex flex-col">
                <label htmlFor="username">
                    {translations.documental_gestion.dependency.form.ciu_id}
                </label>
                <Controller
                    name="ciu_id"
                    control={control}
            ...
            <span className="flex flex-col">
                <label htmlFor="username">{ translations.documental_gestion.dependency.form.trd_charge }</label>
                <Controller
                    name="trd_charge"
                    control={control}
                    render={({ field, fieldState }) => (
                        <div className="flex items-center gap-2">
                            <InputSwitch trueValue={true} falseValue={false} checked={field.value} onChange={field.onChange} />
                            <span>{ field.value ? translations.auth.yes_not.yes : translations.auth.yes_not.no }</span>
                        </div>
                    )}
                    />
            </span>
