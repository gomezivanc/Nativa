...
use App\Models\DependencyTemplate;
use Illuminate\Contracts\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class DependencyTemplateRepository extends BaseRepository{

    public function __construct(DependencyTemplate $modelo){
    ...
    public function findByDependency($id)
    {
        return $this->model
            ->with(['payroll','dependency'])
            ->where('id_dependency', $id)
            ->get();
    }
}