...
use App\Models\UsersGroupsDependency;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;

class UsersGroupsDependencyRepository extends BaseRepository
{
    public function __construct(UsersGroupsDependency $modelo)
    {
